...
typedef void (*rps_rbtree_insert_pt) (rps_rbtree_node_t *root,
    rps_rbtree_node_t *node, rps_rbtree_node_t *sentinel);

struct rps_rbtree_s {
    rps_rbtree_node_t     *root;
    rps_rbtree_node_t     *sentinel; /* 哨兵节点，替代 NULL，简化逻辑 */
    rps_rbtree_insert_pt   insert;   /* 具体的插入算法 */
};
